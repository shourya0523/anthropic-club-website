...
const Home = () => {
  ...
  return (
    <>
      <SEO
        description="Join the Claude Builder Club at Northeastern University. Learn AI, build with Claude Pro, and connect with passionate students. Free API credits, workshops, and exclusive hackathons."
        keywords={[
          "student club",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div className="text-center mb-16" variants={itemVariants}>
              ...
              <p className="text-lg text-neutral-dark max-w-2xl mx-auto mb-12">
                Discover the amazing benefits of being part of the Anthropic
                Club community
              </p>
            </motion.div>
