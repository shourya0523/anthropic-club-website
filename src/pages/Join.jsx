...
const Join = () => {
  ...
  return (
    <>
      <SEO
        title="Join the Club"
        description="Ready to build with AI? Join the Claude Builder Club at Northeastern University. Get FREE Claude Pro access, $50 API credits, and connect with passionate AI builders."
        keywords={[
          "join",
          "membership",
          "registration",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-dark max-w-2xl mx-auto">
              Join the Anthropic Club and start your AI journey. Fill out the
              form below to become a member.
            </p>
          </motion.div>
              ...
              {iframeError ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-neutral-dark mb-6">
                    We're having trouble loading the application form. Please
