...
const Card = ({ 
  ...
  const baseClasses = 'relative overflow-hidden bg-white rounded-2xl shadow-md p-6 transition-all duration-300';
  ...
  return (
    <motion.div
      ...
      whileHover={hover ? { y: -8, boxShadow: colorGlow ? '0 10px 30px -10px rgba(225, 123, 90, 0.5)' : '0 25px 50px -12px rgba(0, 0, 0, 0.25)' } : {}}
    ...
    >
      ...
      {colorGlow && (
        <motion.div
          ...
          style={{
            background: 'radial-gradient(60% 60% at 50% 0%, rgba(225,123,90,0.65) 0%, rgba(225,123,90,0.0) 60%)',
            filter: 'blur(18px)'
          }}
        />
      )}
